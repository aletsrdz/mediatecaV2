...
class MaterialController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Material']))
		{
			...
			$Criteria -> limit = 1;
			$Criteria -> order = "idmaterial DESC";			
						
			foreach(Material::model()->findAll($Criteria) as  $material => $record) { //Este es un ciclo para recuperar el resultado de la consulta, se recupera el dato de idAprendiente
				$idmaterial = $record->idmaterial;
			}
			
			//echo $idaprendiente."</br>";
			//print_r ($id);
			$idmaterial=$idmaterial+1; // Incrmento el valor de idaprendiente en UNO para insertar con el siguiente registro			

			$model->idmaterial = $idmaterial;
			$model->descripcion = strtoupper($_POST['Material']['descripcion']);			
