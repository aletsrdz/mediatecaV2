 ...
 *
 * The followings are the available columns in table 'subdependencia':
 * @property integer $dependencia
 * @property string $subdep
 ...
 */
class Subdependencia extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('dependencia, subdep, nombre, nomabrevia', 'required'),
			array('dependencia', 'numerical', 'integerOnly'=>true),
			array('subdep', 'length', 'max'=>2),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('dependencia, subdep, nombre, nomabrevia', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('subdep',$this->subdep,true);
	 ...
	 * @return Subdependencia the static model class
	 */
    ...
    public function getSelectSubdependencia()
    {
