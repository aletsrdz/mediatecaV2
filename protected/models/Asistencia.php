...
class Asistencia extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('idaprendiente', 'unique', 'message'=>'El Aprendiente ya está en la Mediateca'), 			
			array('idaprendiente','exist','allowEmpty' => false, 'attributeName' => 'idaprendiente', 'className' => 'Aprendiente2', 'message'=>'El aprendiente NO esta inscrito, favor de inscribirse', 'criteria' => array('condition'=> 'inscripcion=:inscripcion', 'params'=>array(':inscripcion'=>'t')), 
				),
